...
import core.*;
import contracts.ConstructContract;
...
public class Villager extends Worker {
    ...
    public Villager(Player p, Cell cell, int cycle) {
        super(p, cell, cycle, VILLAGER_ANIMATION, VILLAGER_SIZE, VILLAGER_SIGHT, VILLAGER_HEALTH, VILLAGER_ENERGY,
                VILLAGER_DEGRADATION_TIME, VILLAGER_DEGRADATION_AMOUNT, VILLAGER_COST, VILLAGER_PRODUCTION);
    }
